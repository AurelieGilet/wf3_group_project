...
INSERT INTO `game` (`id`, `owner_id`, `category_id`, `name`, `public`, `min_players`, `max_players`, `description`, `image`) VALUES
...
(6, 4, 4, 'Just One', '8+', 3, 7, 'Just One est un party game coopératif où vous jouez tous ensemble pour découvrir le plus de mots mystères. Trouvez le meilleur indice pour aider votre équipier et soyez original, car tous les indices identiques seront annulés!', 'Just-One-605b9f1532ba8-jpg'),
